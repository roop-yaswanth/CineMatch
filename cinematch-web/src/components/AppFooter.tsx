      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
        ...
        >
          <svg
            ...
            role="img"
            aria-label="The Movie Database"
            style={{ height: 18, width: 138.5, aspectRatio: "273.42 / 35.52", display: "block" }}
          >
            <defs>
              <linearGradient id="tmdb-footer-gradient" y1="17.76" x2="273.42" y2="17.76" gradientUnits="userSpaceOnUse">
